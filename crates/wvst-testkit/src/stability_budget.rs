...
pub struct StabilityBudget {
    ...
    pub min_bridge_audio_frames_routed: Option<u64>,
    pub max_bridge_audio_backpressure_drops: Option<u64>,
    pub max_bridge_audio_frame_route_failures: Option<u64>,
    pub max_bridge_audio_frame_invalid_headers: Option<u64>,
    pub max_bridge_audio_frame_invalid_lengths: Option<u64>,
    pub max_bridge_audio_frame_unmatched_streams: Option<u64>,
    pub max_bridge_audio_sequence_gap_events: Option<u64>,
    pub max_bridge_audio_sequence_gap_frames: Option<u64>,
    pub max_bridge_audio_frames_duplicate: Option<u64>,
    pub max_bridge_audio_frames_out_of_order: Option<u64>,
    pub max_bridge_audio_frames_late: Option<u64>,
    pub max_bridge_audio_route_latency_p95_us: Option<u64>,
    pub max_bridge_audio_route_latency_p99_us: Option<u64>,
    pub max_bridge_audio_interarrival_jitter_p95_us: Option<u64>,
    pub max_bridge_audio_interarrival_jitter_p99_us: Option<u64>,

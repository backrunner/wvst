...
- macOS 安装、启动、授权和日志已有基础诊断命令支持，`wvst-packager macos` 已提供首版发布 bundle 生成、安装和卸载脚本；Linux 已提供 systemd user service 发布 bundle 生成、安装和卸载脚本；仍缺少 macOS 签名/公证、真实安装验证和更完整的日志采集/轮转命令。
- Windows 真实运行验证、Linux cgroup 资源限制真实部署验证和 Windows 发布打包脚本。

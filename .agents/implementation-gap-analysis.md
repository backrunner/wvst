...
1. 用 `wvst-testkit` runtime matrix JSON manifest 接入真实 macOS VST3 effect/instrument fixture，验证 2-in/2-out process、parameter automation、MIDI mapping 和 zero-input instrument timing。
